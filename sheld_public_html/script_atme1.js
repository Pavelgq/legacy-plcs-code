var j = 1;
        ...
        function getJson(form) {
            ...
            form.find("input, select").each(function (index, element) {
                ...
                } else if ($element.is("input[type='button']")) { //если кнопка то не надо ей состояние вызвращать
                    result[name] = '';
                } else {
        ...
        function loadpage() {
            ...
            $("#kod_d").on("change", function(){$("#kod_unvis").val($("#kod_d").val())});
            ...
            $("input[type='text']").on("change", function () {
                ...
                //alert(id);
                var rr = 0;
                if (id != "my_file_name" && id != "kod_d" && id !="kod_unvis") {
        ...
        function blokpost() {
            ...
            if (n == 0) {
                ...
                $("input[name=send]").val("Расчет геометрии фазы");
            ...
            if (n == 1) {
                ...
                $("input[name=send]").val("Ввод геометрии фазы");
            };
        ...
        function close_pile_list_k1() {
            ...
            switch (reg) {
                case 0:
                    ...
                    if (((k1 == 1) || (k1 == 2)) && (($("input[name=otrezok1]").val() <= d4) || (isNaN($(
                            "input[name=otrezok1]").val())))) {
                        $("input[name=otrezok1]").val(d4);
        ...
        function close_pile_list_k2() {
            ...
            switch (reg) {
                case 0:
                    ...
                    if (((k2 == 1) || (k2 == 2)) && (($("input[name=otrezok2]").val() <= d4) || (isNaN($(
                            "input[name=otrezok2]").val())))) {
                        $("input[name=otrezok2]").val(d4);
        ...
        function close_pile_list_k3() {
            ...
            switch (reg) {
                case 0:
                    ...
                    if (((k3 == 1) || (k3 == 2)) && (($("input[name=otrezok3]").val() <= d4) || (isNaN($(
                            "input[name=otrezok3]").val())))) {
                        $("input[name=otrezok3]").val(d4);
        ...
        function close_pile_list_k4() {
            ...
            switch (reg) {
                case 0:
                    ...
                    if (((k4 == 1) || (k4 == 2)) && (($("input[name=otrezok4]").val() <= d4) || (isNaN($(
                            "input[name=otrezok4]").val())))) {
                        $("input[name=otrezok4]").val(d4);
        ...
        function dinamic_part() {
            ...
            if (d > count) {
                while (d > count) {
                    ...
                    var strong1 = $('<strong/>').text("Протяженность на участке №" + count + ", м:").appendTo(div3);
                    var input1 = $('<input/>', {
                        type: 'text',
                    ...
                    var strong1 = $('<strong/>').text("Протяженность на участке №" + count + ", м:").appendTo(div4);
                    var input1 = $('<input/>', {
                        type: 'text',
                        'class': 'dinamic_t lala',
                        'id': 'dlinn2' + count,
                    ...
                    var strong1 = $('<strong/>').text("Протяженность на участке №" + count + ", м:").appendTo(div5);
                    var input1 = $('<input/>', {
                        type: 'text',
                        'class': 'dinamic_t lala',
                        'id': 'dlinn3' + count,
                    ...
                    var strong1 = $('<strong/>').text("Протяженность на участке №" + count + ", м:").appendTo(div6);
                    var input1 = $('<input/>', {
                        type: 'text',
                        'class': 'dinamic_t lala',
                        'id': 'dlinn4' + count,
        ...
        function mathpath() { // Событие нажатия на кнопку "Расчёт"
        ...
        function mathpath_l2() { // Событие нажатия на кнопку "Эквивалент"
            var d4 = $("input[name=d4]").val() * 1;
            ...
            for (i = 1; i <= count; i++) {
                ...
                L_ob = L_ob + mas[i];
                if (document.getElementById("rasst").options.selectedIndex == 0) { //выбрано "между осями"
        ...
        function all_math_operation() { //Считаем все при нажатии главной кнопки расчет
            if (!decoder()) {
                alert("Вы ввели неверный код активации");
                return 0;
            }
            ...
            var ieig_1 = ie_1 / ig_1; //режим 1 - формула 2
            var ieig_2 = ie_2 / ig_2; //режим 2 - формула 2
            var ieig_3 = ie_3 / ig_3; //режим 3 - формула 2
            ...
            //**************ОДНОСТОРОННЕЕ********************
            var single_regim = document.getElementById("single_reg").options.selectedIndex;
            ...
            var D3 = 0;
            var parametr_ground = document.getElementById("param_ground").options.selectedIndex;
            if (parametr_ground == 0) {
                D3 = 2.24 * (Math.sqrt(pz / (omega * miu)));
            } else if (parametr_ground == 1) {
                D3 = $("input[name=d_glub1]").val() * 1;
            }
            var xge = omega * (miu / (2 * Math.PI)) * lk * Math.log(D3 / (r2 * Math.pow(10, -3)));
            ...
            var neid_detaliz = document.getElementById("ne_trans_select").options.selectedIndex;
            var kn = $("input[name=set_kn]").val() * 1;
            var ck = 1;
            var j = 0;
            var lt = [];
                    ...
                    if (with_n1 > before_n1) {
                        ...
                        if ((before_n1 > count) || (with_n1 > count)) {
                            ...
                            if (lt[i - 1][b - 1] != 0) {
                                ...
                                Xi_mas[i - 1][b - 1] = omega * (miu / (2 * Math.PI)) * lt[i - 1][b - 1] * Math.log((st[
                                    i - 1][b - 1] / r2));
            ...
            if (metka == false) {
                ...
                for (var i = 1; i <= (neid_n + 1); i++) {
                    for (var b = 1; b <= 3; b++) {
                        ...
                        neid_re[i - 1] = (lt[i - 1][0] + lt[i - 1][1] + lt[i - 1][2]) * (pe / fe);
                        neid_X_all[i - 1] = Xi_mas[i - 1][0] + Xi_mas[i - 1][1] + Xi_mas[i - 1][2];

                        kt[i - 1] = Math.sqrt((Math.pow(neid_ue[i - 1][0] - (0.5 * (neid_ue[i - 1][1] + neid_ue[i - 1][
                            2
                        ])), 2) + Math.pow((0.5 * Math.sqrt(3) * (neid_ue[i - 1][1] - neid_ue[i - 1][2])),
                            2))) / (neid_ue[i - 1][0] + neid_ue[i - 1][1] + neid_ue[i - 1][2]); //Этап 2

                        neid_ie[i - 1][b - 1] = (1 / (Math.sqrt(1 + Math.pow((neid_re[i - 1] / neid_X_all[i - 1]), 2)))) *
                            neid_ig[b - 1] * kt[i - 1];

                        neid_ieig[i - 1][b - 1] = neid_ie[i - 1][b - 1] / neid_ig[b - 1];

                        neid_pepg[i - 1][b - 1] = Math.pow(neid_ieig[i - 1][b - 1], 2) * (pe / pg) * (fg / fe);

                        neid_ki[i - 1][b - 1] = 1 / Math.sqrt(1 + neid_pepg[i - 1][b - 1]);

                        neid_rg[i - 1] = (lt[i - 1][0] + lt[i - 1][1] + lt[i - 1][2]) * (pg / fg);

                        neid_pg[i - 1][b - 1] = (3 / 1000) * Math.pow(neid_ig[b - 1], 2) * neid_rg[i - 1] * kn;

                        neid_pe[i - 1][b - 1] = neid_pepg[i - 1][b - 1] * neid_pg[i - 1][b - 1];

                        neid_ce[i - 1][b - 1] = neid_pe[i - 1][b - 1] * 8.760 * C;

                        neid_ue_max[i - 1] = Math.max(neid_ue[i - 1][0], neid_ue[i - 1][2]);
                        neid_ukz[i - 1] = Math.max(Xi_mas[i - 1][0], Xi_mas[i - 1][2]) * ik3;
                        neid_uk1[i - 1] = (2 / 3) * ik1 * Math.max(Xi_mas[i - 1][0], Xi_mas[i - 1][2]);
                ...
                if (neid_detaliz == -1) {
                    ...
                    $("input[name=neid_ieig]").val(sigFigs(neid_ieig[neid_detaliz][neid_reg])); // записываем результат
                    $("input[name=neid_rerg]").val(sigFigs(neid_pepg[neid_detaliz][neid_reg])); // записываем результат
                ...
                if (((neid_reg == 0) && (ig_1 == 0)) || ((neid_reg == 1) && (ig_2 == 0)) || ((neid_reg == 2) && (ig_3 ==
                        0))) {
            ...
            var param_xez = omega * (miu / (2 * Math.PI)) * 1000 * Math.log(Math.pow((D3 * 1000), 3) / (r2 * Math.pow(
                S_sr, 2)));
            var h = Math.pow(param_re, 2) / (Math.pow(param_re + 3 * param_r3, 2) + Math.pow(param_xez, 2));

            var param_ek_ground = document.getElementById("param_ek_ground").options.selectedIndex;
            var param_r1 = [];
            var param_r0 = [];
            ...
            var param_x0 = [];
            var r1 = ($("#d1").val() * 1) / 2;
            param_x1[0] = omega * (miu / (2 * Math.PI)) * 1000 * Math.log((S_sr / r1) * Math.pow((r2 / S_sr), v));
            param_x1[1] = omega * (miu / (2 * Math.PI)) * 1000 * Math.log((S_sr / r1) * Math.pow((r2 / S_sr), 0));
            param_x1[2] = param_x1[1];

            param_x0[0] = omega * (miu / (2 * Math.PI)) * 1000 * Math.log((Math.pow(D3 * 1000, 3 * h)) / (r1 * Math.pow(
                r2, h - 1) * Math.pow(S_sr, 2 * h)));
            param_x0[1] = omega * (miu / (2 * Math.PI)) * 1000 * Math.log((Math.pow(D3 * 1000, 3 * 1)) / (r1 * Math.pow(
                r2, 1 - 1) * Math.pow(S_sr, 2 * 1)));
            ...
            var param_cc = ((2 * Math.PI * 8.85 * Math.pow(10, -12) * d_elec1) / Math.log(r2 / r1)) * Math.pow(10, 9);
        ...
        function decoder() {
            ...
            var id_progr = parseInt(my_serial.substring(my_serial.length - 6, my_serial.length - 3));
